# Medical Imaging Segmentation Toolkit (TensorFlow)
...
and test a variety of models, loss functions, and other parameters for 3D medical imaging 
segmentation. The following architectures are implemented on MIST:
