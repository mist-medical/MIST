...
class Postprocess(object):
    ...
    def use_clean_mask(self):
        ...
        if not(os.path.exists(os.path.join(self.params['prediction_dir'], 'train', 'postprocess', 'clean_mask'))):
            os.mkdir(os.path.join(self.params['prediction_dir'], 'train', 'postprocess', 'clean_mask'))
    ...
    def connected_components_analysis(self):
        ...
        for i in range(1, len(self.params['labels'])):
            ...
            if not(os.path.exists(os.path.join(self.params['prediction_dir'], 'train', 'postprocess', str(self.params['labels'][i])))):
                os.mkdir(os.path.join(self.params['prediction_dir'], 'train', 'postprocess', str(self.params['labels'][i])))
